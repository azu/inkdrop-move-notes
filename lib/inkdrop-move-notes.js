"use babel";
const NAMESPACE = "inkdrop-move-notes";
/**
...
module.exports = {
    ...
    async activate() {
        ...
        // add command
        config.forEach(item => {
            inkdrop.commands.add(document.body, `inkdrop-move-notes:${item.commandName}`, async () => {
                // command
                try {
                ...
                submenu: [
                    {
                        ...
                        submenu: config.map(item => {
                            return {
                                ...
                                "command": `inkdrop-move-notes:${item.commandName}`
                            };
                        }),
                    },
                ],
